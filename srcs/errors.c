...
/*   Updated: 2018/05/02 18:03:35 by jecarol          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../includes/sh.h"

int			ft_error3(int code, char *cmd, char *arg)
{
	if (code == 7)
	{
	...
	if (code == 10)
	{
		ft_putstr_fd("21sh: \"&&\" and \"||\" operators aren't handled yet", 2);
		ft_putchar('\n');
		return (0);
	}
	return (1);
...
int			ft_error2(int code, char *cmd, char *arg)
{
	if (code == 4)
	{
